...
namespace FetchBlobFileInfoCore
{
    class Program
    {
        ...
        {
            ListAndRecordBlobSegments().Wait();
        }
        ...
        private static async Task ListAndRecordBlobSegments()
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    var blobResult = await directory.ListBlobsSegmentedAsync(true, BlobListingDetails.None, null, continuationToken, null, null);
                    ...
                    var fileItemInfos = ToFileItemInfos(blobResult.Results, Helper.PathCombine(containerName, path)).ToList();
