    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string continuationToken = specifiedContinuationTokenStr;
                ...
                var s3Client = new AmazonS3Client(credential, config);
                s3Client = SwitchClient(s3Client);
        ...
        private static AmazonS3Client SwitchClient(AmazonS3Client s3Client)
        {
            ...
            GetBucketLocationResponse resp = s3Client.GetBucketLocation(bucketName);
